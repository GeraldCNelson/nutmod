...
Sweave( "compileMacroAMDR.Rnw", driver = cacheSweaveDriver, encoding = "utf-8")
Sweave( "compileFoodgroupAvailability1.Rnw", driver = cacheSweaveDriver, encoding = "utf-8")
Sweave( "compileFoodgroupAvailability2.Rnw", driver = cacheSweaveDriver, encoding = "utf-8")
Sweave( "compileFoodgroupAvailability3.Rnw", driver = cacheSweaveDriver, encoding = "utf-8")
...
tools::texi2pdf("compileMacroAMDR.tex", clean = FALSE, quiet = TRUE)
tools::texi2pdf("compileFoodgroupAvailability1.tex", clean = FALSE, quiet = TRUE)
tools::texi2pdf("compileFoodgroupAvailability2.tex", clean = FALSE, quiet = TRUE)
tools::texi2pdf("compileFoodgroupAvailability3.tex", clean = FALSE, quiet = TRUE)

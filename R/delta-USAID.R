...
dt.IMPACTfood[scenario == "SSP2-NoCC", scenario := "REF_NoCC"]
dt.IMPACTfood[scenario == "SSP2-HGEM2", scenario := "REF_HGEM"]
dt.IMPACTfood[scenario == "SSP2-IPSL2", scenario := "REF_IPSL"]
dt.IMPACTfood[scenario == "SSP2-HGEM-LoYld2", scenario := "MED"]
dt.IMPACTfood[scenario == "SSP2-HGEM-RegYld2", scenario := "REGION"]
dt.IMPACTfood[scenario == "SSP2-HGEM-HiYld2", scenario := "HIGH"]
dt.IMPACTfood[scenario == "SSP2-HGEM-HiNARS2", scenario := "HIGH_NARS"]
dt.IMPACTfood[scenario == "SSP2-HGEM-HiREFF2", scenario := "HIGH_RE"]
dt.IMPACTfood[scenario == "SSP2-HGEM-IRREXP2", scenario := "IX"]
dt.IMPACTfood[scenario == "SSP2-NoCC-IRREXP2", scenario := "IX_NoCC"]
dt.IMPACTfood[scenario == "SSP2-IPSL-IRREXP2", scenario := "IX_IPSL"]
dt.IMPACTfood[scenario == "SSP2-HGEM-IRREXP-WUE2", scenario := "IX_WUE"]
dt.IMPACTfood[scenario == "SSP2-NoCC-IRREXP-WUE2", scenario := "IX_WUE_NoCC"]
dt.IMPACTfood[scenario == "SSP2-IPSL-IRREXP-WUE2", scenario := "IX_WUE_IPSL"]
dt.IMPACTfood[scenario == "SSP2-HGEM-SWHC2", scenario := "ISW"]
dt.IMPACTfood[scenario == "SSP2-NoCC-SWHC2", scenario := "ISW_NoCC"]
dt.IMPACTfood[scenario == "SSP2-IPSL-SWHC2", scenario := "ISW_IPSL"]
dt.IMPACTfood[scenario == "SSP2-HGEM-PHL-DEV2", scenario := "RPHL"]
dt.IMPACTfood[scenario == "SSP2-HGEM-MMEFF2", scenario := "RMM"]
dt.IMPACTfood[scenario == "SSP2-HGEM-Pangloss2", scenario := "COMP"]
dt.IMPACTfood[scenario == "SSP2-NoCC-Pangloss2", scenario := "COMP_NoCC"]
dt.IMPACTfood[scenario == "SSP2-IPSL-Pangloss2", scenario := "COMP_IPSL"]
...
# regionCodesAggReg1
temp <- data.table::copy(dt.regions.all)
temp <- temp[region_code.AggReg1 %in% regionCodesAggReg1,]
keepListCol <- c("region_code.IMPACT159", "region_code.AggReg1", "region_name.AggReg1")
dt.region_codes.AggReg1 <- unique(temp[, (keepListCol), with = FALSE])
data.table::setnames(dt.region_codes.AggReg1, old = c("region_code.AggReg1", "region_name.AggReg1"), new = c("region_code", "region_name"))
# regionCodesAggReg2
temp <- data.table::copy(dt.regions.all)
...
dt.region_codes.AggReg2 <- unique(temp[, (keepListCol), with = FALSE])
data.table::setnames(dt.region_codes.AggReg2, old = c("region_code.AggReg2", "region_name.AggReg2"), new = c("region_code", "region_name"))
...
dt.region_codes.2EconGroup <- unique(temp[, (keepListCol), with = FALSE])
data.table::setnames(dt.region_codes.2EconGroup, old = c("region_code.EconGroup", "region_name.EconGroup"), new = c("region_code", "region_name"))
# regionCodesWBEconGroup
temp <- data.table::copy(dt.regions.all)
temp <- temp[region_code.WB %in% regionCodesWB,]
keepListCol <- c("region_code.IMPACT159", "region_code.WB", "region_name.WB")
dt.region_codes.WB <- unique(temp[, (keepListCol), with = FALSE])
data.table::setnames(dt.region_codes.WB, old = c("region_code.WB", "region_name.WB"), new = c("region_code", "region_name"))
...
temp[scenario == scenario.base, newOrder := 1] [scenario == "SSP1-NoCC-REF" ,newOrder := 2][scenario == "SSP3-NoCC-REF" ,newOrder := 3]
...
boxPlotSingle <- function(dt, fileName, titleText, yRange) {
  ...
  temp <- temp[year == "X2010" & scenario == scenario.base |
                 year == "X2050" ,]
  temp <- temp[year == "X2010", scenario := "2010"]
  par(mfrow = c(1,1))
  pdf(paste("graphics/", fileName, ".pdf", sep = ""))
  ...
  text(c(1, 2, 2.8, 3.6, 4.6, 5.2, 6), par("usr")[3] - 2, srt = 45, adj = 1,
       labels = labels, xpd = TRUE)
...
data.table::setorder(temp,newOrder)
temp[, newOrder := NULL]
temp[year == "X2010", scenario := "2010"][, year := NULL]
yrange <- range(temp$value)
par(mfrow = c(1,1))

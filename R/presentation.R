...
imageList.wb <- c("fig1.budgetShare_WB.base.pdf", "fig1.budgetShare_WB.var.pdf", "fig1.budgetShare_WB.varFort.pdf",
...
imageList.tenregions <- c("figS8.foodavail.1_tenregions.base.pdf", "figS8.foodavail.1_tenregions.var.pdf", "figS8.foodavail.1_tenregions.varFort.pdf",
...
targetDirNfileName <- paste0("presentations/",gdxChoice, "/", outputName, ".pptx" )

print(my_pres.tenregions, target = targetDirNfileName)

#print(my_pres.wb, target = "presentations/comparisons.WB.pptx")

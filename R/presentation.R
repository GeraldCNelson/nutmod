...
contentString <- paste0("Nutrient Modeling Results Comparison, ten regions for ", gdxChoice, ', created ', Sys.Date())
titleContentString.tenregions <- paste0("ph_with_text(x = my_pres.tenregions, type = 'ctrTitle', str =  '", contentString, "')")
